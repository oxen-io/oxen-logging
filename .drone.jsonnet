...
[
  ...
  debian_pipeline('Debian 12 static', docker_base + 'debian-bookworm', deps=['g++']),
  debian_pipeline('Debian 12 bookworm (i386)', docker_base + 'debian-bookworm/i386'),
  debian_pipeline('Debian 11 bullseye (amd64)', docker_base + 'debian-bullseye', deps=default_deps, extra_setup=debian_backports('bullseye', ['cmake'])),
  debian_pipeline('Debian 10 buster (amd64)', docker_base + 'debian-buster', deps=default_deps, extra_setup=kitware_repo('bionic')),
  debian_pipeline('Debian 10 static Debug', docker_base + 'debian-buster', build_type='Debug', deps=['g++'], extra_setup=kitware_repo('bionic')),
  debian_pipeline('Ubuntu latest (amd64)', docker_base + 'ubuntu-rolling'),
  debian_pipeline('Ubuntu 22.04 jammy (amd64)', docker_base + 'ubuntu-jammy'),
  debian_pipeline('Ubuntu 20.04 focal (amd64)', docker_base + 'ubuntu-focal', deps=default_deps, extra_setup=kitware_repo('focal')),
  debian_pipeline('Ubuntu 18.04 bionic (amd64)',
                  docker_base + 'ubuntu-bionic',
                  deps=['g++-8'] + default_deps_base,
